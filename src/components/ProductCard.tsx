...
export default function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <div ref={cardRef} className="group relative bg-card rounded-2xl border overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1 flex flex-col">
      {/* Image */}
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        <div className="flex items-center justify-between mt-auto">
          ...
          <Button
            size="icon"
            className="h-8 w-8 rounded-xl transition-transform duration-150"
